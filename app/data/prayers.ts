...
export const prayerCategories: PrayerCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'prayers-of-saints',
        title: 'Prayers of Saints',
        description: 'Prayers composed by the saints themselves.',
        image: jesusImage,
        icon: 'leaf-outline',
        season: 'ordinary_time',
        featuredLabel: 'Prayers from the saints',
        prayers: [
          {
            id: 'st-thereese-prayer',
            title: 'Prayer of St. Therese',
            subtitle: 'A prayer of childlike trust',
            excerpt: 'Embrace the “little way” of trust and love with St. Therese’s prayer.',
            content:
              'O Jesus, my love, my all, my soul in its entirety is but a tiny spark of love which I send forth to You. I cannot give You anything except myself, for I have nothing else to give. Look upon me with eyes of mercy and love, and accept this little spark of love which I send forth to You. O Jesus, my love, accept this poor heart of mine which longs to love You more and more. Amen.',
            tags: ['Saints', 'St. Therese', 'Trust'],
            season: 'ordinary_time',
            estimatedDuration: '2 min',
            searchTerms: ['st therese', 'little way', 'childlike trust'],
            reading: defaultReading,
          },
          {
            id: 'st-john-of-the-cross-prayer',
            title: 'Prayer of St. John of the Cross',
            subtitle: 'A prayer for union with God',
            excerpt: 'Seek deeper union with God through the “dark night” with St. John’s prayer.',
            content:
              'O my beloved, my soul is thirsting for You, my flesh is longing for You, as in a dry and weary land where there is no water. O living flame of love, that tenderly wounds my soul in its deepest center! Since I have tasted Your sweetness, I desire to see You, to be with You, and to embrace You. Amen.',
            tags: ['Saints', 'St. John of the Cross', 'Union with God'],
            season: 'ordinary_time',
            estimatedDuration: '3 min',
            searchTerms: ['st john of the cross', 'dark night', 'union with god'],
            reading: defaultReading,
          },
          {
            id: 'st-catherine-of-siena-prayer',
            title: 'Prayer of St. Catherine of Siena',
            subtitle: 'A prayer for love and zeal',
            excerpt: 'Ask for a heart on fire with love for God and neighbor with St. Catherine’s prayer.',
            content:
              'O Lord, I am not worthy to receive You, but only say the word and I shall be healed. O Lord, inflame my heart with Your love, that I may love You with all my strength and all my soul, and that I may love my neighbor as myself for Your sake. Amen.',
            tags: ['Saints', 'St. Catherine of Siena', 'Love'],
            season: 'ordinary_time',
            estimatedDuration: '2 min',
            searchTerms: ['st catherine of siena', 'love prayer', 'zeal'],
            reading: defaultReading,
          },
          {
            id: 'st-thomas-aquinas-prayer',
            title: 'Prayer of St. Thomas Aquinas(Students Prayer)',
            subtitle: 'A prayer for wisdom and understanding',
            excerpt: 'Ask St. Thomas Aquinas for wisdom and clarity in study and life.',
            content:
              'Come, Holy Spirit, Divine Creator, the true source of light and fountaion of wisdom. Pour forth your brilliance upon my intellect, dissipate the darkness which covers me, that of sin and of ignorance. Grant me, O merciful God, a mind to understand, a heart to meditate, a tongue to proclaim, and a life to practice the sublime mysteries of Your love. Amen.',
            tags: ['Saints', 'St. Thomas Aquinas', 'Wisdom'],
            season: 'ordinary_time',
            estimatedDuration: '2 min',
            searchTerms: ['st thomas aquinas', 'students prayer', 'wisdom'],
            reading: defaultReading,
          },
          {
            id: 'st-teresa-of-avila-prayer',
            title: 'Prayer of St. Teresa of Avila',
            subtitle: 'A prayer for perseverance in prayer',
            excerpt: 'Ask St. Teresa for perseverance and fervor in prayer and spiritual life.',
            content:
            ...
            tags: ['Saints', 'St. Teresa of Avila', 'Perseverance'],
            season: 'ordinary_time',
            estimatedDuration: '1 min',
